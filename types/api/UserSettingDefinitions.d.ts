...
export declare const UserSettingsDefinitions: Record<PropertyKey, UserSettingDefinition<any>> | undefined;
/**
 ...
 */
export declare function getUserSettingDefinition<T = any>(group: string, name: string): UserSettingDefinition<T> | undefined;
/**
 ...
 * @param name The name of the setting
 */
export declare function getUserSettingDefinitionLazy<T = any>(group: string, name: string): UserSettingDefinition<T> | undefined;
export {};
