 ...
 */
export declare const ChatBarButtonWrappers: Map<string, ChatBarButtonWrapperData>;
export declare const addChatBarButtonWrapper: (id: string, wrapper: ChatBarButtonWrapper, priority?: number) => Map<string, ChatBarButtonWrapperData>;
export declare const removeChatBarButtonWrapper: (id: string) => boolean;
export declare function _wrapButtons(buttons: ReactNode): ReactNode;
