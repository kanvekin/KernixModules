...
export declare let PendingReplyStore: t.PendingReplyStore;
...
export declare let ExperimentStore: t.ExperimentStore;
export declare let UserAffinitiesStore: t.UserAffinitiesStore;
export declare let ApplicationStreamingStore: t.ApplicationStreamingStore;
export declare let ApplicationStreamPreviewStore: t.ApplicationStreamPreviewStore;
/**
