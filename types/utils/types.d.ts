...
export declare const PluginTags: readonly ["Accessibility", "Activity", "Appearance", "Chat", "Commands", "Console", "Customisation", "Developers", "Emotes", "Friends", "Fun", "Media", "Notifications", "Organisation", "Privacy", "Reactions", "Roles", "Servers", "Shortcuts", "Utility", "Voice"];
...
export interface PluginDef {
    ...
    /**
     * A Vencord plugin that is modified for extra features in Kernixcord
     */
    isModified?: boolean;
}
...
export type SettingsChecks<D extends SettingsDefinition> = {
    [K in keyof D]?: D[K] extends PluginSettingComponentDef ? IsDisabledOrHidden<DefinedSettings<D>> : (IsDisabledOrHidden<DefinedSettings<D>> & IsValid<PluginSettingType<D[K]>, DefinedSettings<D>>);
};
export type PluginSettingDef = PluginSettingCustomDef | PluginSettingComponentDef | PluginSettingStringDef | PluginSettingNumberDef | PluginSettingBooleanDef | PluginSettingSelectDef | PluginSettingSliderDef | PluginSettingBigIntDef;
...
export interface DefinedSettings<Def extends SettingsDefinition = SettingsDefinition, PrivateSettings extends object = {}> {
