...
export declare function openPrivateChannel(userId: string, navigateToChannel?: boolean): any;
 ...
 */
export declare function fetchUserProfile(id: string, options?: FetchUserProfileOptions, cache?: boolean): Promise<import("@vencord/discord-types").UserProfile | undefined>;
/**
