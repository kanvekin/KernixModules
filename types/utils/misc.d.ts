...
export declare const isKernixcordPluginDev: (id: string) => boolean;
export declare const shouldShowKernixcordContributorBadge: (id: string) => boolean;
export declare const isAnyPluginDev: (id: string) => boolean;
...
export declare function isKernixcordGuild(id: string | null | undefined, isGuildId?: boolean): boolean;
export declare function isSupportChannel(channelId: string | null | undefined): boolean;
export declare function isKnownIssuesCategory(channelId: string | null | undefined): boolean;
export declare function isKernixcordSupport(userId: string | null | undefined): boolean;
export declare function removeFromArray<T>(arr: T[], predicate: (e: T) => boolean): void;
export declare function getUserAvatarUrl(user: User, guildId?: string, canAnimate?: boolean, size?: number): string;
